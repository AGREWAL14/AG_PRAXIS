...
The gap between weighted and macro F1 is the aggregate that a class-imbalanced task hides behind: accuracy and weighted F1 read high while the smallest classes are undetected.
